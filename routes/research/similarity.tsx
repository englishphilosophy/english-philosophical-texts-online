...
import EMPLSimilarityTable from "../../islands/EMPLSimilarityTable.tsx";
import DissertationSimilarityTable from "../../islands/DissertationSimilarityTable.tsx";
    ...
    <Info pageId="similarity" pages={researchPages}>
      <div className="content">
        ...
        <p>
          ...
          <i>term frequency-inverse document frequency</i> of every lemma in
          every text. This standard measure from information theory multiplies
          the frequency of a term with the logarithmically scaled inverse of the
          number of documents in the corpus that contain the term. Plainly put,
          infrequent words have a low TF-IDF value, as do very frequent but very
          common words (‘a’, ‘in’, ‘the’, ‘to’, etc.); while the words that are
          both frequent in the document are rare in the corpus as a whole score
          highly. This provides a good estimate of the most important words in a
          text.
        </p>
        ...
        <p>
          ...
          measure is calculated as follows: take the frequency of each term in
        ...
        <p>
          The following tables show, for each of the essays in Hume’s{" "}
        ...
        <p>
          ...
          striking is the very high similarity between <i>Of Tragedy</i> and
          section 6 of the <i>Dissertation on the Passions</i>. These two parts
          of Hume’s opus were originally side by side in his{" "}
          <i>Four Dissertations</i> of 1757, but he separated them soon after
          (for the 1758 edition of his <i>Essays and Treatises</i>). The results
          here suggest that separation may have been unfortunate.
        </p>
        <DissertationSimilarityTable />
      </div>
    </Info>
  </Page>
);
