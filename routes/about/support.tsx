...
export default () => (
  <Page
    ...
    nav={
      <hgroup>
        <h1>About: {aboutTitles.support}</h1>
      </hgroup>
    }
  >
    <Info pageId="support" pages={aboutPages}>
...
const statements: Statement[] = [
  {
    text:
      "This open-access resource is very welcome: it offers an impressive collection ranging from well-known canonical texts to currently neglected early modern voices which deserve to be heard.",
  ...
  {
    text:
      "I very much appreciate and support the <i>English Philosophical Texts Online</i> project.",
    from: "Jani Hakkarainen",
    affiliation: "Tampere University, Finland",
  },
  {
    text:
      "This is a fantastic resource that provides the only reliable, searchable texts of several major early modern philosophers. I hope you get the support you need to make it fully comprehensive.",
    from: "James A. Harris",
  ...
  {
    text:
      "I am writing this to communicate my appreciation and support for your English Philosophical Texts Online project. I would also like to thank you for the huge benefit I have received from Hume Texts Online.",
    from: "Naohito Mori",
