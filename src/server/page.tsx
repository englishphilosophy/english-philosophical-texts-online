...
export const AuthorPage: FC<{ author: Author; analysis: Analysis }> = ({
  author,
  analysis,
}) => (
...
export const TextPage: FC<{ text: Text; analysis: Analysis }> = ({
  text,
  analysis,
}) => (
  <Page
...
export const ResearchPage: FC<{ id?: ResearchPageId }> = ({
  id = "research",
}) => (
  <Page
    section="Research"
