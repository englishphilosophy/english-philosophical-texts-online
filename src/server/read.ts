...
export const flatLexicon = (): Promise<FlatLexicon> => fetchData('lexicon-flat') as Promise<FlatLexicon>

export const reducedLexicon = (): Promise<ReducedLexicon> => fetchData('lexicon-reduced') as Promise<ReducedLexicon>

export const authors = async (): Promise<Author[]> => (await fetchData('index') as { texts: Author[] }).texts
