...
export const pages: PageDetails[] = [
  { id: "research", title: titles.research, url: "/research" },
  { id: "similarity", title: titles.similarity, url: "/research/similarity" },
  { id: "topics", title: titles.topics, url: "/research/topics" },
];

/** Content for the main research page. */
export const research = element("div", {
  class: "content",
  children: [
    element("h1", { innerHTML: titles.research }),
    element("p", {
      innerHTML:
