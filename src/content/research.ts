...
export const research = element('div', { class: 'content', children: [
...
export const similarity = element('div', { class: 'content', children: [
  ...
  element('h2', { innerHTML: 'Hume’s <i>Essays, Moral, Political, and Literary, Part 1</i>' }),
  ...
  data.emplTable(0),
  element('h2', { innerHTML: 'Hume’s <i>Essays</i> and the <i>Four Dissertations</i>' }),
...
export const topics = element('div', { class: 'content', children: [
