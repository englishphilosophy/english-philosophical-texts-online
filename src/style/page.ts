...
function head (options: PageOptions): Element {
  ...
  return element('head', { children: [
    ...
    element('meta', { name: 'keywords', content: 'english, philosophy, texts, hobbes, locke, hume, mill, shaftesbury' }),
    element('meta', { name: 'description', content: 'High-quality digital editions of a broad canon of English philosophical texts published between 1650 and 1830.' }),
    element('title', { innerHTML: title }),
    element('style', { type: 'text/css', innerHTML: css }),
    element('link', { rel: 'shortcut icon', href: '/favicon.ico' }),
    element('script', { async: true, src: 'https://www.googletagmanager.com/gtag/js?id=UA-23731986-3' }),
    element('script', { innerHTML: 'window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag(\'js\', new Date());gtag(\'config\', \'UA-23731986-3\');' }),
    element('script', { defer: true, module: true, src: '/js/client/app.js' })
  ]})
}

/** Generates the body element. */
function body (options: PageOptions): Element {
  return element('body', { class: options.bodyClass, children: [
...
function header (section: string): Element {
  return element('header', { children: [
    element('hgroup', { children: [
      element('h1', { innerHTML: 'English Philosophical Texts Online' }),
      element('h2', { innerHTML: 'A free online library of early modern English-language philosophical texts' })
    ] }),
...
/** The footer element. */
const footer = element('footer', { children: [
  element('section', { children: [
    ...
    element('ul', { children: [
      element('li', { children: [
        element('a', { href: 'https://englishphilosophy.org', innerHTML: 'English Philosophical Texts Online' })
      ] }),
      element('li', { children: [
        element('a', { href: 'https://davidhume.org', innerHTML: 'Hume Texts Online' })
      ] }),
      element('li', { children: [
        element('a', { href: 'https://github.com/englishphilosophy', innerHTML: 'Early English Philosophy @ GitHub' })
      ] })
    ] })
  ] })
] })
