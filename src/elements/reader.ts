...
export const text = (text: Text, analysis: Analysis): Element => {
  return element("div", {
    ...
    children: [
      ...
      section(
        textContent(text, analysis, "content"),
        textSelect(text, "content")
      ),
    ],
  });
};
...
export const author = (author: Author, analysis: Analysis): Element => {
  return element("div", {
    ...
    children: [
      ...
      section(
        authorContent(author, analysis, "works"),
        authorSelect(author, "works")
      ),
    ],
  });
};
...
const section = (content: Element, select?: Element): Element => {
  return element("div", {
    ...
    children: [
      element("div", {
        class: "section",
        children: select ? [select, content] : [content],
      }),
    ],
  });
};
...
const textSelect = (text: Text, section: TextSection): Element => {
  return element("select", {
    ...
    children: [
      ...
      element("optgroup", {
        label: "About",
        children: [option("About", "about", section === "about")],
      }),
    ],
  });
};
